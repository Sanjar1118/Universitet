  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/admin_panel" class="nav-link">Ortga qaytish</a>
      </li>
  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tabelni ozgartirish</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-4 col-4">
              <div class="card">
                  <div class="card-header text-danger">Ozgartirish uchun boshqattan toldiring</div>
                  <div class="card-body">
                  <form action="{{route('admin_up', $lesson->id)}}" method="POST">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" name="teacher" placeholder="Ustzning ismi" value="{{$lesson->teacher}}" required>
                    </div>
                    <button class="btn btn-primary mt-3">Ozgartirish</button>
                  </form>
                  </div>
              </div>
          </div>
